package com.hawesome.bleconfig.view.main
...
import com.hawesome.bleconfig.ext.startActivity
import com.hawesome.bleconfig.ext.toResDrawable
import com.hawesome.bleconfig.kit.BluetoothKit
import com.hawesome.bleconfig.kit.TagKit
import com.hawesome.bleconfig.model.XSLocation
import com.hawesome.bleconfig.view.config.ConfigActivity
import com.hawesome.bleconnector.view.main.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        swipeRefresh.setOnRefreshListener {
            scanDevicesWithPermissionCheck()
        ...
        updateImage.setOnClickListener {
            ...
            intent.data = Uri.parse("http://s.eds.ink/download/faconfig")
        ...
        viewModel.connectResult.observe(this@MainActivity) { result ->
            if (result.getOrNull() ?: false) {
                ...
                val type = BluetoothKit.getDeviceType(device.name)
                TagKit.onConnected(type)
                startActivity<ConfigActivity>(this) {
                    this.putExtra(ConfigActivity.EXT_DEVICE, device)
                }
            } else {
                R.string.blue_connect_failure.showToast()
            }
    ...
    inner class DeviceAdapter : RecyclerView.Adapter<DeviceAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            val bleName = deviceList[position].name
            val deviceType = BluetoothKit.getDeviceType(bleName)
